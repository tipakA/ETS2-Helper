...
export const map: Array<CountryData> = [
  {
    ...
    cities: [
      ...
      { name: 'wien', dealer: 'Iveco', discovered: true, garage: { level: null }, laborExchange: true, whole: true },
    ],
  },
  {
    name: 'belgium',
  ...
  },
  {
    name: 'czech',
    cities: [
      { name: 'brno', dealer: null, discovered: true, garage: { level: null }, laborExchange: true, whole: false },
  ...
  },
  {
    name: 'finland',
    cities: [
      { name: 'helsinki', dealer: false, discovered: true, garage: { level: null }, laborExchange: true, whole: false },
      ...
      { name: 'lahti', dealer: false, discovered: true, garage: { level: null }, laborExchange: true, whole: false },
      ...
      { name: 'turku', dealer: false, discovered: true, garage: { level: null }, laborExchange: true, whole: false },
    ],
  },
  {
    name: 'france',
    cities: [
      ...
      { name: 'bourges', dealer: 'Renault', discovered: true, garage: null, laborExchange: null, whole: false },
      ...
      { name: 'paris', dealer: 'Renault', discovered: true, garage: { level: null }, laborExchange: false, whole: false },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: 'dresden', dealer: false, discovered: true, garage: { level: null }, laborExchange: true, whole: false },
      { name: 'duisburg', dealer: null, discovered: true, garage: { level: null }, laborExchange: null, whole: false },
      { name: 'dusseldorf', dealer: false, discovered: true, garage: { level: null }, laborExchange: null, whole: false },
      { name: 'erfurt', dealer: null, discovered: true, garage: { level: null }, laborExchange: null, whole: false },
      ...
      { name: 'magdeburg', dealer: null, discovered: true, garage: { level: null }, laborExchange: null, whole: false },
      ...
      { name: 'nurnberg', dealer: false, discovered: true, garage: { level: null }, laborExchange: false, whole: false },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: 'messina', dealer: null, discovered: true, garage: { level: null }, laborExchange: null, whole: false },
      { name: 'milano', dealer: 'Scania', discovered: true, garage: { level: null }, laborExchange: false, whole: false },
      { name: 'napoli', dealer: 'Volvo', discovered: true, garage: { level: null }, laborExchange: true, whole: false },
      ...
      { name: 'torino', dealer: 'Iveco', discovered: true, garage: { level: null }, laborExchange: null, whole: false },
  ...
  },
  {
    name: 'netherlands',
    cities: [
      { name: 'amsterdam', dealer: 'DAF', discovered: true, garage: { level: null }, laborExchange: null, whole: false },
      { name: 'groningen', dealer: null, discovered: true, garage: { level: null }, laborExchange: true, whole: false },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: 'poznan', dealer: null, discovered: true, garage: { level: 1 }, laborExchange: true, whole: false },
      { name: 'szczecin', dealer: 'Mercedes-Benz', discovered: true, garage: { level: 1 }, laborExchange: true, whole: false },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: 'bystrica', dealer: null, discovered: true, garage: { level: null }, laborExchange: null, whole: false },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: 'algeciras', dealer: null, discovered: true, garage: { level: null }, laborExchange: null, whole: false },
      ...
      { name: 'barcelona', dealer: 'Renault', discovered: true, garage: { level: null }, laborExchange: null, whole: false },
      ...
      { name: 'cordoba', dealer: 'MAN', discovered: true, garage: { level: null }, laborExchange: null, whole: false },
      ...
      { name: 'granada', dealer: null, discovered: true, garage: null, laborExchange: null, whole: false },
      ...
      { name: 'malaga', dealer: false, discovered: true, garage: { level: null }, laborExchange: true, whole: false },
      ...
      { name: 'sevilla', dealer: false, discovered: true, garage: { level: null }, laborExchange: null, whole: false },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: 'kalmar', dealer: 'Mercedes-Benz', discovered: true, garage: { level: null }, laborExchange: null, whole: false },
      ...
      { name: 'orebro', dealer: null, discovered: true, garage: { level: null }, laborExchange: null, whole: false },
      { name: 'sodertalje', dealer: null, discovered: true, garage: null, laborExchange: null, whole: true },
