  ...
  [ // France
    'france', {
      cities: new Collection<CityName, City>([
        ...
        [ 'la rochelle', { dealer: null, discovered: true, garage: { level: null }, laborExchange: false, whole: false }],
        ...
        [ 'nantes', { dealer: 'Mercedes-Benz', discovered: true, garage: { level: null }, laborExchange: null, whole: false }],
        ...
        [ 'rennes', { dealer: null, discovered: true, garage: { level: null }, laborExchange: true, whole: false }],
  ...
  [ // Spain
    'spain', {
      cities: new Collection<CityName, City>([
        ...
        [ 'algeciras', { dealer: null, discovered: true, garage: { level: null }, laborExchange: null, whole: false }],
        ...
        [ 'barcelona', { dealer: false, discovered: true, garage: { level: null }, laborExchange: null, whole: false }],
        ...
        [ 'zaragoza', { dealer: 'Iveco', discovered: true, garage: { level: null }, laborExchange: true, whole: false }],
      ]),
    },
  ],
  [ // Sweden
