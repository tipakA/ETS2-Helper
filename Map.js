...
const map = new Collection([
  ...
  [ // Italy
    'italy', {
      cities: new Collection([
        ...
        [ 'genova', { dealer: null, discovered: true, garage: { level: null, owned: false }, laborExchange: null, whole: false }],
        ...
        [ 'milano', { dealer: 'Scania', discovered: true, garage: { level: null, owned: false }, laborExchange: false, whole: false }],
  ...
  [ // Poland
    'poland', {
      cities: new Collection([
        [ 'bialystok', { dealer: null, discovered: true, garage: { level: 1, owned: true }, laborExchange: true, whole: false }],
        [ 'gdansk', { dealer: 'Scania', discovered: true, garage: { level: 2, owned: true }, laborExchange: true, whole: true }],
        [ 'katowice', { dealer: null, discovered: true, garage: { level: 1, owned: true }, laborExchange: null, whole: false }],
        [ 'krakow', { dealer: 'MAN', discovered: true, garage: { level: 1, owned: true }, laborExchange: true, whole: true }],
        [ 'lodz', { dealer: null, discovered: true, garage: { level: 1, owned: true }, laborExchange: false, whole: false }],
        [ 'lublin', { dealer: null, discovered: true, garage: { level: 1, owned: true }, laborExchange: null, whole: false }],
        [ 'olsztyn', { dealer: null, discovered: true, garage: { level: 1, owned: true }, laborExchange: null, whole: false }],
        [ 'poznan', { dealer: null, discovered: true, garage: { level: 1, owned: true }, laborExchange: false, whole: false }],
        [ 'szczecin', { dealer: false, discovered: true, garage: { level: 1, owned: true }, laborExchange: true, whole: false }],
        [ 'warszawa', { dealer: 'Mercedes-Benz', discovered: true, garage: { level: 2, owned: true }, laborExchange: true, whole: false }],
        [ 'wroclaw', { dealer: 'Volvo', discovered: true, garage: { level: 1, owned: true }, laborExchange: null, whole: false }],
      ]),
    },
  ],
  [ // Romania
  ...
  [ // UK
    'uk', {
      cities: new Collection([
        ...
        [ 'plymouth', { dealer: false, discovered: true, garage: { level: null, owned: false }, laborExchange: true, whole: false }],
