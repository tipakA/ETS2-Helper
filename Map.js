  ...
  [ // France
    'france', {
      cities: new Collection([
        ...
        [ 'bourges', { dealer: false, discovered: false, garage: { level: null, owned: false }, laborExchange: null, whole: false }],
        ...
        [ 'civaux', { dealer: null, discovered: false, garage: { level: null, owned: false }, laborExchange: null, whole: false }],
        ...
        [ 'golfech', { dealer: null, discovered: false, garage: { level: null, owned: false }, laborExchange: null, whole: false }],
        ...
        [ 'metz', { dealer: null, discovered: false, garage: { level: null, owned: false }, laborExchange: true, whole: false }],
        [ 'montpelier', { dealer: null, discovered: false, garage: { level: null, owned: false }, laborExchange: null, whole: false }],
        ...
        [ 'paluel', { dealer: null, discovered: false, garage: { level: null, owned: false }, laborExchange: null, whole: false }],
        [ 'paris', { dealer: false, discovered: false, garage: { level: null, owned: false }, laborExchange: false, whole: false }],
        [ 'reims', { dealer: null, discovered: false, garage: { level: null, owned: null }, laborExchange: false, whole: false }],
        [ 'rennes', { dealer: null, discovered: false, garage: { level: null, owned: false }, laborExchange: false, whole: false }],
        [ 'roscoff', { dealer: null, discovered: false, garage: { level: null, owned: false }, laborExchange: null, whole: false }],
        [ 'saint-alban', { dealer: null, discovered: false, garage: { level: null, owned: false }, laborExchange: null, whole: false }],
        [ 'saint-laurent', { dealer: null, discovered: false, garage: { level: null, owned: false }, laborExchange: null, whole: false }],
        [ 'strasbourg', { dealer: false, discovered: false, garage: { level: null, owned: false }, laborExchange: null, whole: false }],
        [ 'toulouse', { dealer: false, discovered: false, garage: { level: null, owned: false }, laborExchange: true, whole: false }],
      ]),
    },
  ],
  [ // Germany
